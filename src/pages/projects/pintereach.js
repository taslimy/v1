...
export class Pintereach extends Component {
  render() {
    return (
      <Layout>
        <section>
          ...
          <div className="projectHead">
            ...
            />
            <h1>Pintereach</h1>
            <h2>Node.js Back-end Developer</h2>
            <ul>
              <li>Node.js, JWT, Bcrypt.js, Knex.js, PostgreSQL, Heroku</li>
            </ul>
